...
<meta content="dist/xlsx.full.min.js · master · mirrors / SheetJS / js-xlsx" property="og:title">
...
<meta content="https://gitcode.net/mirrors/SheetJS/js-xlsx/-/blob/master/dist/xlsx.full.min.js" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="dist/xlsx.full.min.js · master · mirrors / SheetJS / js-xlsx" property="twitter:title">
...
<title>dist/xlsx.full.min.js · master · mirrors / SheetJS / js-xlsx ·  GitCode</title>
...
<meta name="csrf-token" content="ViTHNQyTG3abqI6traERfCk2nYwOostMyYzgmKTwdN82vZ3H/M905Proh3SE4XIFXr3miUGhSgDboh5dVLNBzA==" />
<meta name="csp-nonce" content="CNQ+RwH77hvE9mIhRrWXGg==" />
...
<body class="ui-indigo tab-width-8  gl-browser-chrome gl-platform-windows" data-find-file="/mirrors/SheetJS/js-xlsx/-/find_file/master" data-group="SheetJS" data-namespace-id="9912" data-page="projects:blob:show" data-page-type-id="master/dist/xlsx.full.min.js" data-project="js-xlsx" data-project-id="3903">
...
<script src="/assets/drag_sort/sortable.min-b2de54b4d3ef84fe9656f624cc02d4b9b1d9754fb038148ff1fe06422b5f0f46.js" defer="defer" nonce="CNQ+RwH77hvE9mIhRrWXGg=="></script>
<script src="/assets/side_toolbar-d302f567974818ad159162cb05e273dbf0ac2a382fa364a403de4b801761fed3.js" defer="defer" nonce="CNQ+RwH77hvE9mIhRrWXGg=="></script>
...
<div class="js-signature-container" data-signatures-path="/mirrors/SheetJS/js-xlsx/-/commits/81b231d866b104a583e4e8a21f5f39445286bfee/signatures?limit=1"></div>
...
<input type="hidden" name="path" id="path" value="dist/xlsx.full.min.js" />
...
<li class="breadcrumb-item">
<a href="/mirrors/SheetJS/js-xlsx/-/tree/master/dist">dist</a>
</li>
<li class="breadcrumb-item">
<a href="/mirrors/SheetJS/js-xlsx/-/blob/master/dist/xlsx.full.min.js"><strong>xlsx.full.min.js</strong>
</a></li>
</ul>
</div>
...
</a><a class="btn js-blob-blame-link" href="/mirrors/SheetJS/js-xlsx/-/blame/master/dist/xlsx.full.min.js">Blame</a><a class="btn" href="/mirrors/SheetJS/js-xlsx/-/commits/master/dist/xlsx.full.min.js">历史</a><a class="btn js-data-file-blob-permalink-url" href="/mirrors/SheetJS/js-xlsx/-/blob/515d1c6f2e1d3ca422ee9198b177cfd926434936/dist/xlsx.full.min.js">永久链接</a><a class="gl-button btn js-data-file-blob-permalink-url" href="/mirrors/SheetJS/js-xlsx/-/blob/515d1c6f2e1d3ca422ee9198b177cfd926434936/dist/xlsx.full.min.js">Permalink</a></div>
</div>

<div class="info-well d-none d-sm-block">
<div class="well-segment">
<ul class="blob-commit-info">
<li class="commit flex-row js-toggle-container" id="commit-81b231d8">
...
<a class="commit-row-message item-title js-onboarding-commit-item " href="/mirrors/SheetJS/js-xlsx/-/commit/81b231d866b104a583e4e8a21f5f39445286bfee">version bump 0.18.12</a>
<span class="commit-row-message d-inline d-sm-none">
&middot;
81b231d8
</span>
<div class="committer">
由 <a class="commit-author-link" href="mailto:dev@sheetjs.com">SheetJS</a> 提交于 <time class="js-timeago" title="9月 22, 2022 5:05下午" datetime="2022-09-22T09:05:24Z" data-toggle="tooltip" data-placement="bottom" data-container="body">9月 22, 2022</time>
</div>
...
<button class="btn gl-button btn btn-default" data-toggle="tooltip" data-placement="bottom" data-container="body" data-title="复制提交SHA" data-class="gl-button btn btn-default" data-clipboard-text="81b231d866b104a583e4e8a21f5f39445286bfee" type="button" title="复制提交SHA" aria-label="复制提交SHA"><svg class="s16" data-testid="copy-to-clipboard-icon"><use xlink:href="/assets/icons-15cbe21ccc2237b075efb0b0d170fc8d6716882dbe4fefad34c18b914dbcf811.svg#copy-to-clipboard"></use></svg></button>
...
<a class="js-fork-suggestion-button gl-button btn btn-grouped btn-inverted btn-success" rel="nofollow" data-method="post" href="/mirrors/SheetJS/js-xlsx/-/blob/master/dist/xlsx.full.min.js">Fork</a>
...
<div class="blob-viewer" data-path="dist/xlsx.full.min.js" data-type="simple" data-url="/mirrors/SheetJS/js-xlsx/-/blob/master/dist/xlsx.full.min.js?format=json&amp;viewer=simple">
...
<div class="modal-content">
<div class="modal-header">
<h3 class="page-title">Replace xlsx.full.min.js</h3>
<button aria-label="关闭" class="close" data-dismiss="modal" type="button">
<span aria-hidden>&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-quick-submit js-upload-blob-form" data-method="put" action="/mirrors/SheetJS/js-xlsx/-/update/master/dist/xlsx.full.min.js" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="ir2D+vqH8Bc0VOcvR4VCQB3NBGe1WSMs9DTg2+E9yLjqJNkICtufhVUU7vZuxSE5akZ/YvpaomDmGh4eEX79qw==" /><div class="dropzone">
...
<label class="col-form-label col-sm-2" for="commit_message-6f719d1b4aa53807014c072c064b94f5">提交信息
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-6f719d1b4aa53807014c072c064b94f5" class="form-control js-commit-message" placeholder="Replace xlsx.full.min.js" required="required" rows="3">
Replace xlsx.full.min.js</textarea>
</div>
</div>
</div>
...
<div class="modal-body">
<div class="container-fluid">
<form class="custom-notifications-form" id="edit_notification_setting_3452533" action="/-/notification_settings/3452533" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="patch" /><input type="hidden" name="authenticity_token" value="KNCEfutxqnPtx2YNLyjCLtYhzUmiCPAK+2yjjKenJn5ISd6MGy3F4YyHb9QGaKFXoaq2TO0LcUbpQl1JV+QTbQ==" /><input type="hidden" name="project_id" id="project_id" value="3903" />
<input type="hidden" name="hide_label" id="hide_label" value="true" />
<div class="row">
<div class="col-lg-4">
