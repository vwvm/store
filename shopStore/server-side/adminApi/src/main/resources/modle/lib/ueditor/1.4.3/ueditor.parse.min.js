...
".edui-chart-container { height:"+(this.chartContainerHeight||300)+"px}");var c=this.rootPath,e=com.liuvei.spring.config.root,k=null;c&&(e=e?h(e):null,(k=e)&&a())});UE.parse.register("background",function(f){for(var h=com.liuvei.spring.config.root.getElementsByTagName("p"),g,a=0,d; d=h[a++];)(g=d.getAttribute("data-background"))&&d.parentNode.removeChild(d);g&&f.cssRule("ueditor_background",this.selector+"{"+g+"}",document)});UE.parse.register("list",function(f){function h(b){var d=this;f.each(b,function(b){if(b.className&&/custom_/i.test(b.className)){var e=
...
"-paddingleft{padding-left:35px}");break;case "dot":f.pushItem(g,c+" li.list-"+e+"-paddingleft{padding-left:20px}")}}})}var g=[],a={cn:"cn-1-",cn1:"cn-2-",cn2:"cn-3-",num:"num-1-",num1:"num-2-",num2:"num-3-",dash:"dash",dot:"dot"};f.extend(this,{liiconpath:"http://bs.baidu.com/listicon/",listDefaultPaddingLeft:"20"});var d=com.liuvei.spring.config.root,b=d.getElementsByTagName("ol"),d=d.getElementsByTagName("ul"),c=this.selector;b.length&&h.call(this,b);d.length&&h.call(this,d);if(b.length||d.length)g.push(c+" .list-paddingleft-1{padding-left:0}"),
g.push(c+" .list-paddingleft-2{padding-left:"+this.listDefaultPaddingLeft+"px}"),g.push(c+" .list-paddingleft-3{padding-left:"+2*this.listDefaultPaddingLeft+"px}"),f.cssRule("list",c+" ol,"+c+" ul{margin:0;padding:0;}li{clear:both;}"+g.join("\n"),document)});UE.parse.register("vedio",function(f){var h=com.liuvei.spring.config.root.getElementsByTagName("video"),g=com.liuvei.spring.config.root.getElementsByTagName("audio");document.createElement("video");document.createElement("audio");if(h.length||g.length){var h=f.removeLastbs(this.rootPath),
